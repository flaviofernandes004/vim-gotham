...
let s:colors.base5 = { 'gui': '#237088', 'cterm': 15 }
let s:colors.base6 = { 'gui': '#599cab', 'cterm': 14 }
let s:colors.base7 = { 'gui': '#99d1ce', 'cterm': 7 }
let s:colors.base8 = { 'gui': '#d3ebe9', 'cterm': 15 }
...
" Folds.
call s:Col('Folded', 'base7', 'base0')
call s:Col('FoldColumn', 'base6', 'base3')
...
" Popup menu.
call s:Col('Pmenu', 'base7', 'base2')
call s:Col('PmenuSel', 'base8', 'base4')
...
call s:Col('WildMenu', 'base8', 'cyan')

" The 'Hit ENTER to continue prompt'.
call s:Col('Question', 'green')

" Tab line.
call s:Col('TabLineSel', 'base8', 'base4')  " the selected tab
call s:Col('TabLine', 'base7', 'base2')     " the non-selected tabs
call s:Col('TabLineFill', 'base0', 'base0') " the rest of the tab line

" Spelling.
call s:Col('SpellBad', 'base8', 'red')
call s:Col('SpellCap', 'base8', 'blue')
call s:Col('SpellLocal', 'yellow')
call s:Col('SpellRare', 'base8', 'violet')

" Diffing.
call s:Col('DiffAdd', 'base8', 'green')
call s:Col('DiffChange', 'base8', 'blue')
call s:Col('DiffDelete', 'base8', 'red')
call s:Col('DiffText', 'base8', 'cyan')
...
" CtrlP
call s:Col('CtrlPNoEntries', 'base8', 'orange') " no entries
...
call s:Col('CtrlPPtrCursor', 'base8')           " cursor in the prompt

" unite.vim
call s:Col('UniteGrep', 'base8', 'green')
